...
const DemoContext_27 = React.createContext();
...
const DemoProvider_27 = ({children}) => {
    ...
    return (
        <DemoContext_27.Provider value={{...state}}>
            {children}
        </DemoContext_27.Provider>
    )


}

const useDemoContext_27 = () => {
    return useContext(DemoContext_27);
}

export { DemoProvider_27, useDemoContext_27}