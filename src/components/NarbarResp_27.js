...
import Wrapper from '../assets/wrapper/NavbarResp_27';
            ...
            <li className="menu-item dropdown">
              ...
              <div className="sub-menu-wrapper slideInUp">
                <ul className="sub-menu">
                  <li className="menu-item"><Link to="/card_27">Static</Link></li>
                  <li className="menu-item"><Link to="/local_27">Local json</Link></li>
                  <li className="menu-item"><Link to="/supabase_27">Supabase</Link></li>
                  <li className="menu-item"><Link to="/node_27">Node Server</Link></li>
                </ul>
              </div>
            </li>
